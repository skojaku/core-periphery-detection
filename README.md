...
| Algorithm | Reference |
|-----------|-----------|
| [cpnet.BE](cpnet/BE.py) | S. P. Borgatti and M. G. Everett. Models of core/periphery structures. Social Networks, 21, 375–395, 2000 [論文へのリンク https://www.doi.org/... を全て入れるのはどうでしょう。arxiv は arxiv の URL で引くのだが、もちろん。] |
...
| [cpnet.LowRankCore](cpnet/Cucuringu.py)  | M. Cucuringu, P. Rombach, S. H. Lee, and M. A. Porter Detection of core-periphery structure in networks using spectral methods and geodesic paths. Euro. J. Appl. Math., 846–887, 2016 [ここからの3行は、何らかの意味でまとめて1つにできないの？ また、journal name は full 綴りにしよう] |
...
| [cpnet.KM_ER](cpnet/KM_ER.py) | S. Kojaku and N. Masuda. Finding multiple core-periphery pairs in networks. Phys. Rev. E, 96, 052313, 2017 |
| [cpnet.KM_config](cpnet/KM_config.py) | S. Kojaku and N. Masuda. Core-periphery structure requires something else in networks. New J. Phys., 20, 043012, 2018 [この行と次の行も何らかの意味でまとめて1つにできる？]|
