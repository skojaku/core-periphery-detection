...
| [cpnet.Surprise](cpnet/Surprise.py) ([a faster and more versatile version](https://github.com/EmilianoMarchese/SurpriseMeMore) is proposed in [a follow-up study](https://arxiv.org/abs/2106.05055)) | [J. van Lidth de Jeude, G. Caldarelli, T. Squartini. Detecting Core-Periphery Structures by Surprise. EPL, 125, 2019](https://epljournal.edpsciences.org/articles/epl/abs/2019/06/epl19592/epl19592.html) |
